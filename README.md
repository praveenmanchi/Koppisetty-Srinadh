...
- New Shiki code highlighting them light/dark
- Moved forms to their own pages 
------
Updated on 17th February 2025

## This update includes:

Full redesign of the template, with a new look and feel but keeping the sidebar layout and adding animations
...
ProFolioX has a dark mode toggle on the navigation that saves the state on localStorage.

- AOS
This update includes the integration of the AOS library, which is a library that automatically animates elements on a web page.
